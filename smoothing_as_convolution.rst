...
(:math:`y_i : i \in 0, 1, .. 39`) multiplied by their respective kernel
y values (:math:`k_i : i \in 0, 1, .. 39`):
...
product <https://en.wikipedia.org/wiki/Dot_product>`__ of the two
vectors:
...
If are you :doc:`familiar with convolution <on_convolution>` the smoothing
...
invariance <https://en.wikipedia.org/wiki/Convolution#Translation_invariance>`__
...
crude method in the :doc:`smoothing_intro`.
